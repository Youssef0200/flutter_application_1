...
extension DataSourceExtension on DataSource {
  AppiErrorModel getFailure() {
    switch (this) {
      case DataSource.NO_CONTENT:
        return AppiErrorModel(
...
class ErrorHandler implements Exception {
  late AppiErrorModel apiErrorModel;
...
AppiErrorModel _handleError(DioException error) {
  switch (error.type) {
    ...
    case DioExceptionType.badResponse:
      if (error.response != null &&
        ...
        return AppiErrorModel.fromJson(error.response!.data);
      } else {
